				...
				<article>
					<div class="art-header">
						...
						<div class="col-2-3">
							<div class="wrap-col">
								<ul>
									<li><p>Tags: <a href="#">${film.filmtype }</a></p></li>
									<li><p>Production: <a href="#">${film.filmtype }</a></p></li>
									<li><p>Actor: <a href="#">${film.actor }</a></p></li>
									<li><p>Director: <a href="#">${film.dector }</a></p></li>
									<li><p>Nation: <a href="#">${film.country }</a></p></li>
									<li><p>Upload: <a href="#">${film.year }n</a></p></li>
